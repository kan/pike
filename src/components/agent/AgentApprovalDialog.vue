...
import { AlertTriangle, Shield, Terminal, Wrench } from 'lucide-vue-next'
    ...
    <div v-if="show" class="approval-overlay">
      <div class="approval-dialog" @click.stop>
        ...
        >
          ...
          <button class="btn approval-session" @click="respond('allowAlways')">
            {{ t('codex.acceptForSession') }}
          </button>
          <button class="btn approval-decline" @click="respond('reject')">
            {{ t('codex.decline') }}
          </button>
