export default {
  ...
  'todo.clearDone': '完了したものを削除',
  'todo.clearDoneConfirm': '完了したタスク {count} 件を削除します。よろしいですか？',
  ...
  'todo.toggleDetail': '詳細を開閉',
  'todo.hasDetail': '詳細あり',
  'todo.detailPlaceholder': '詳細（メモ・手順など）…',
  ...
  'agentStatus.unknown': '取得できていません',
  'agentStatus.configDirDefault': '既定',
  'agentStatus.model': 'モデル',
  'agentStatus.cost': '費用',
  'agentStatus.sessionCount': 'セッション数',
  'agentStatus.lastUsed': '最終利用',
  'agentStatus.noRate': '利用率を取得できていません',
  'agentStatus.noTokens': '集計対象のセッションがありません',
  'agentStatus.noCodex': 'このプロジェクトでの Codex の記録はありません',
  'agentStatus.codexChat': 'チャットタブ',
  'agentStatus.codexCli': 'CLI 由来',
  ...
  'codex.approvalTool': '{tool} の実行を許可しますか？',
  'codex.cwd': '作業ディレクトリ',
  'codex.accept': '許可',
