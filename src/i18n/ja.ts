export default {
  ...
  'sync.target.none': '同期しない',
  'sync.target.gist': 'GitHub Gist',
  'sync.target.file': 'ファイル',
  'sync.ghPlace': 'gh コマンド',
  'sync.ghPlaceHint':
    'Gist の読み書きに使う GitHub CLI（gh）の場所です。ログイン（gh auth login）はこの gh で済ませておきます。この選択は同期しません。',
  'sync.ghPlaceHost': 'このマシン（ホスト）',
  'sync.gist': 'Gist',
  'sync.gistHint':
    '同期に使う Gist の ID です。1 台目は「Gist を作る」で secret の Gist を作り、2 台目以降は「既存の Gist から選ぶ」で同じ Gist を選びます。',
  'sync.gistPlaceholder': 'Gist の ID',
  'sync.gistCreate': 'Gist を作る',
  'sync.gistChoose': '既存の Gist から選ぶ',
  'sync.gistNone': '同期ファイルを持つ Gist が見つかりませんでした。',
  'sync.gistUse': '使う',
  'sync.ghMissing': 'gh が見つかりません。GitHub CLI を入れるか、gh コマンドの場所を選び直してください。',
  'sync.ghAuth': 'gh がログインしていません。ターミナルで gh auth login を実行してください。',
  'sync.staleRead': 'Gist からこのマシンが書く前の版が返ったため、同期を見送りました。次の同期で読み直します。',
  'sync.status': '同期',
  'sync.syncNow': '今すぐ同期',
  'sync.syncing': '同期しています…',
  'sync.lastSynced': '{at} に同期しました。',
  'sync.error': '同期に失敗しました: {message}',
  'sync.unreadable': '同期ファイルを JSON として読めませんでした。書き込みは行っていません。',
  'sync.busy': '同期ファイルが同期の途中で何度も書き換えられたため、中止しました。少し待ってからやり直してください。',
  'sync.projectSummary':
  ...
  'sync.firstSyncHint':
    'この同期先と初めて同期したため、このマシンと同期ファイルで値が違う項目をすべて並べています。まとめて決めるときは「すべてローカル」か「すべてリモート」を選んでから「選んだ内容で同期」を押してください。',
  'sync.noConflicts': '衝突はありません。',
  'sync.allLocal': 'すべてローカル',
  'sync.allRemote': 'すべてリモート',
  'sync.apply': '選んだ内容で同期',
  'sync.chosen': '{chosen} / {total} 件を選択',
  'sync.local': 'このマシン（ローカル）',
  'sync.remote': '同期ファイル（リモート）',
  'sync.backup': 'エクスポートとインポート',
  'sync.backupFile': 'ファイルへ書き出す / ファイルから取り込む',
  'sync.backupHint':
    '同期ファイルと同じ形の JSON を、毎回ファイルを選んで書き出し・読み込みします。書き出すのは同期する対象の選択に依らず全部です。取り込むときは、手元と違う項目を一覧にして選べます。',
  'sync.export': 'エクスポート…',
  'sync.import': 'インポート…',
  'sync.exported': '{path} に書き出しました。',
  'sync.importTitle': '設定のインポート',
  'sync.importChoose': 'ファイルを選ぶ',
  'sync.importFrom': '読み込んだファイル: {path}',
  'sync.importHint':
    '手元と値が違う項目です。取り込む項目は「取り込むファイル」の側を選んでください。選ばなかった項目は手元のまま残ります。手元にだけある項目は消しません。',
  'sync.importFile': '取り込むファイル',
  'sync.importAll': 'すべて取り込む',
  'sync.importNone': 'すべて手元のまま',
  'sync.importChosen': '取り込む {chosen} / {total} 件',
  'sync.importApply': '選んだ項目を取り込む',
  'sync.importNoDiff': '手元と違う項目はありません。',
  'sync.importEmpty': '取り込むファイルを選んでください。',
  'sync.importMissing': 'ファイルが見つかりません。',
  'sync.imported': '{count} 件を取り込みました。',
  'sync.value.absent': '（削除）',
  'sync.value.projectKept': '（残す）',
  'sync.item.project': '{name}（プロジェクトの有無）',
  'sync.item.group': 'グループ「{name}」',
  'sync.item.groupOrder': 'グループの並び順',
  'sync.item.projectOrder': '「{group}」のプロジェクトの並び順',
  'sync.ungrouped': 'グループなし',
  'sync.field.name': '名前',
  'sync.field.color': '色',
  'sync.field.icon': 'アイコン',
  'sync.field.group': 'グループ',
  'sync.field.remoteUrl': 'リモートの URL',
  'sync.field.golangciCommand': 'golangci-lint のコマンド',
  ...
  'vuePreview.fillValues': '値を入れる',
  'vuePreview.usingValues': '仮の値を使用中',
  'vuePreview.fillHint':
    '値は JSON で入れます（文字列は引用符なしでも可）。空の欄は与えません。入れた値はプロジェクトの .pike/preview/ に保存します。',
  'vuePreview.initialValue': '初期値',
  'vuePreview.fromComposables': 'composable から受け取った値（{count} 件）',
  'vuePreview.apply': '適用',
