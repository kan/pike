...
const defaultLight: EditorThemeDef = {
  ...
  extension: makeTheme(
    ...
    [
      ...
      { tag: [tags.typeName, tags.className, tags.changed, tags.annotation, tags.modifier, tags.self, tags.namespace], color: "#e36209" },
...
const dracula: EditorThemeDef = {
  ...
  extension: makeTheme(
    ...
    [
      ...
      { tag: [tags.typeName, tags.className, tags.changed, tags.annotation, tags.modifier, tags.self, tags.namespace], color: "#8be9fd" },
...
const nord: EditorThemeDef = {
  ...
  extension: makeTheme(
    ...
    [
      ...
      { tag: [tags.typeName, tags.className, tags.changed, tags.annotation, tags.modifier, tags.self, tags.namespace], color: "#8fbcbb" },
...
const solarizedLight: EditorThemeDef = {
  ...
  extension: makeTheme(
    ...
    [
      ...
      { tag: [tags.typeName, tags.className, tags.changed, tags.annotation, tags.modifier, tags.self, tags.namespace], color: "#b58900" },
...
const monokai: EditorThemeDef = {
  ...
  extension: makeTheme(
    ...
    [
      ...
      { tag: [tags.typeName, tags.className, tags.changed, tags.annotation, tags.modifier, tags.self, tags.namespace], color: "#66d9ef", fontStyle: "italic" },
