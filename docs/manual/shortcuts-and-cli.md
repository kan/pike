...
- **プロジェクト**：登録済みのプロジェクトを最近開いた順に表示します。選ぶと、そのプロジェクトのウィンドウが開いていればフォーカスし、開いていなければ新しいウィンドウで開いてセッションを復元します。ルートがこのマシンに無いプロジェクトは、開いたウィンドウで [clone するかを確認](projects-and-windows.md#開こうとしたときに-clone-する)します。
